...

{
	public class CloudViewModel1 : MainViewModel
	{
		...
		// Initialize Patients collection
            ...
            {
               new  Patient { Name = "John, Doe", Gender = "Male" , Age = 30, ID = 345675},
               new  Patient { Name = "Jane, Smith",Gender = "Male", Age = 25, ID = 345676 },
               new Patient { Name = "Sam, Brown", Gender = "Male",Age = 40, ID = 345677 },
			   
			   new Patient { Name = "Wiiliam, Smith",Gender = "Male", Age = 38, ID = 345678 },
			   new Patient { Name = "Angalina, john",Gender = "Female", Age = 34, ID = 345679 }
